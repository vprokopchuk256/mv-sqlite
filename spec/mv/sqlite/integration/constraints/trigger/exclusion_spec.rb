    ...
    Class.new(::ActiveRecord::Migration) do
      def change
        create_table :table_name, id: false do |t|
          ...
          ##time
          ###array
          t.time :time_array, validates: { exclusion: { in: [Time.new(2011, 1, 1, 1, 1, 1), Time.new(2012, 2, 2, 2, 2, 2)], allow_nil: true, as: :trigger, message: 'time_array_error' }}
          ###range
          t.time :time_range, validates: { exclusion: { in: Time.new(2011, 1, 1, 1, 1, 1)..Time.new(2012, 2, 2, 2, 2, 2), allow_nil: true, as: :trigger, message: 'time_range_error' }}
