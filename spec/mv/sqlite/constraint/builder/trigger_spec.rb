...
describe Mv::Sqlite::Constraint::Builder::Trigger do
  before do
  ...
  describe "#validation_builders" do
    ...
    describe "when exlusion validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Exclusion) }
    end
    ...
    describe "when inclusion validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Inclusion) }
    end
    ...
    describe "when length validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Length) }
    end
    ...
    describe "when presence validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Presence) }
    end
    ...
    describe "when absence validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Absence) }
    end
    ...
    describe "when custom validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Custom) }
    end
    ...
    describe "when uniqueness validation provided" do
      ...
      its(:first) { is_expected.to be_a_kind_of(Mv::Sqlite::Validation::Builder::Trigger::Uniqueness) }
    end
  end

  describe "SQL methods" do
    let(:test_validation_builder_klass) do
      Class.new(Mv::Sqlite::Validation::Builder::Trigger::Presence) do
        def conditions
    ...
    def triggers name
      ActiveRecord::Base.connection.select_values("SELECT name FROM sqlite_master WHERE name = '#{name}';")
    end

    before do
      Mv::Sqlite::Constraint::Builder::Trigger.validation_builders_factory.register_builder(
    ...
    after do
      Mv::Sqlite::Constraint::Builder::Trigger.validation_builders_factory.register_builder(
        Mv::Core::Validation::Presence, 
        Mv::Sqlite::Validation::Builder::Trigger::Presence
      )
    end
    ...
    before do
      ...
      ActiveRecord::Base.connection.execute('CREATE TABLE table_name(column_name varchar);')
    end

    let(:create_trigger_builder) { Mv::Sqlite::Constraint::Builder::Trigger.new(create_trigger)}
    let(:update_trigger_builder) { Mv::Sqlite::Constraint::Builder::Trigger.new(update_trigger)}
      ...
      describe "when trigger exists" do
        before do 
          ActiveRecord::Base.connection.execute(
            ...
            BEGIN
              SELECT RAISE(ABORT, 'error') WHERE NOT(1 = 1);
            END;"
          )
        end
