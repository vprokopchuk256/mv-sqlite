...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-03-22}
  s.description = %q{Migration Validators project sqlite driver}
  ...
  s.homepage = %q{http://github.com/vprokopchuk256/mv-sqlite}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{Migration Validators project sqlite driver}
  s.test_files = [
